...
export interface KAP20mineInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "maxELap", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "maxELap", data: BytesLike): Result;
...
export interface KAP20mine extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KAP20mineInterface;
  ...
  functions: {
    ...
    maxELap(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    miningReward(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    mineBKNext(bkNextAddr: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    maxELap(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    miningReward(overrides?: CallOverrides): Promise<PopulatedTransaction>;
